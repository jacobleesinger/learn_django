...
class QuestionViewTests(TestCase):
    def test_index_view_with_no_questions(self):
        """
        If no questions exist, an appropriate message should be displayed on
        the index page
        """
    ...
    def test_index_with_future_question_and_past_question(self):
        """
        Even if both future and past questions exist, only past questions should
        be displayed.
        """
        create_question(question_text="Past question.", days=-30)
        create_question(question_text="Future question.", days=30)
...
class QuesionIndexDetailTests(TestCase):
